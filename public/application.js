...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetShows = function onGetShows() {
	  // event.preventDefault();
	  // let data = getFormFields(event.target);
	  api.displayShow().then(ui.onDisplaySuccess);
	  // .catch(ui.onDisplayFailure);
	};

	var onClearShows = function onClearShows(event) {
	  event.preventDefault();
	  ui.clearShows();
	};

	var onRemoveShow = function onRemoveShow(event) {
	  event.preventDefault();
	  ...
	  api.removeShow(id).then(ui.onRemoveSuccess).then(onGetShows).catch(ui.onError);
	  onGetShows();
	};

	var onEditShow = function onEditShow(event) {
	  event.preventDefault();
	  ...
	  // console.log(data);
	  api.editShow(id, data).then(ui.onEditSuccess).then(onGetShows).catch(ui.onEditError);
	  ui.clearShows();
	  onGetShows();
	};
	...
	var onAddShow = function onAddShow(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addShow(data).then(ui.onAddSuccess).then(onGetShows).catch(ui.onAddError);
	  onGetShows();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexShow = function indexShow() {
	  return $.ajax({
	...
	var displayShow = function displayShow() {
	  return $.ajax({
	    url: config.apiOrigin + '/shows/',
	    method: 'GET',
	    headers: {
	...
	var removeShow = function removeShow(id) {
	  return $.ajax({
	...
	var editShow = function editShow(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/shows/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayShowsTemplate = __webpack_require__(15);

	var onDisplaySuccess = function onDisplaySuccess(data) {
	  var displayShowsHtml = displayShowsTemplate({ shows: data.shows });
	...
	var clearShows = function clearShows() {
	  $('.show-log-two').empty();
	  $('.log').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n    <!-- <small>"
	    ...
	    + "</small>\n    <small>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.band : stack1), depth0))
	    + "</small>\n    <small>"
	    ...
	    + "</td>\n          <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"remove-show glyphicon glyphicon-remove-sign\"></button>\n\n          <li data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"dropdown\">\n            <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"> <b>Edit Show</b> </a>\n            <ul class=\"dropdown-menu\">\n              <li>\n            <form data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"edit-show\">\n              <div class=\"form-group\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"date\" name=\"show[date]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.date : stack1), depth0))
	    + "\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"text\" name=\"show[band]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.band : stack1), depth0))
	    + "\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"text\" name=\"show[venue]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.venue : stack1), depth0))
	    + "\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"text\" name=\"show[location]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.location : stack1), depth0))
	    + "\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"number\" name=\"show[rating]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + "\">\n               <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"text\" name=\"show[notes]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
	    + "\">\n               <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-date=\""
	    ...
	    + "\" data-notes=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
	    + "\" type=\"submit\" name=\"button\" class=\"edit-show glyphicon glyphicon-edit\"></button>\n              </div>\n           </form>\n        </tr>\n      </tbody>\n    </table>\n        <!-- <small><button id=\"removeShowsButton\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default\">Delete Show</button></small> -->\n    </form>\n  </h1>\n  <!-- <div>\n"
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.shows : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
